...
export default function FormularioTareaClase12() {
  ...
  return (
    <div className="estiloBorder">
      Formulario Tarea Clase 12
      <p>Crear un post en jsonplaceholder</p>
      <p>
        {/* ✅ Mostrar los datos del objeto resultado */}
        {resultado && !resultado.error && (
          <div>
            ...
            <p>
              <strong>Título:</strong> {resultado.title}
            </p>
            <p>
              <strong>Cuerpo:</strong> {resultado.body}
            </p>
            <p>
              <strong>Usuario ID:</strong> {resultado.userId}
            </p>
          </div>
        )}
      </p>
